...
export default function SoftwareEngineerDayPage() {
  ...
  const storyUrl = language === "en" ? "/en/careers/stories/software-engineer-day" : "/kariyer/hikayeler/yazilim-muhendisi-gunu";
            ...
            {story?.description && (
              <div 
                ...
                dangerouslySetInnerHTML={{ 
                  __html: language === "en" 
                    ? (story.descriptionEn || story.description).replace(/\n/g, '<br />')
