...
export default function FiveReasonsPage() {
  ...
  const reasons = language === "en"
    ...
    : [
        "İşbirlikçi İnsanlar: Sağlık teknolojisine tutkulu yetenekli bireylerle çalışın",
        "Büyüme Fırsatları: Sürekli öğrenme ve kariyer geliştirme programları",
        "Anlamlı Etki: Çalışmanız doğrudan hasta bakımını ve sağlık sonuçlarını iyileştirir",
        "Yenilik Kültürü: Sağlık bilişiminde son teknoloji projelerin parçası olun",
        "İş-Yaşam Dengesi: Esnek çalışma düzenlemeleri ve destekleyici ekip ortamı",
      ];
