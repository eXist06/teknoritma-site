          ...
          {(isAdmin || isSarusHub) && (
            <div className="mt-8 pt-8 border-t border-neutral-border">
              <div className="flex items-center justify-between mb-4">
                ...
                >
                  {healthLoading ? "Kontrol Ediliyor..." : "Yenile"}
                </button>
              </div>
                  ...
                  <div className={`p-4 rounded-lg border-2 ${
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className={`font-bold ${healthCheck.status === "ok" ? "text-green-700" : "text-red-700"}`}>
                        Genel Durum: {healthCheck.status === "ok" ? "OK" : "HATA"}
                      </span>
                    </div>
                    <p className="text-sm text-neutral-body">
                      Son kontrol: {new Date(healthCheck.timestamp).toLocaleString("tr-TR")}
                    </p>
                  </div>
